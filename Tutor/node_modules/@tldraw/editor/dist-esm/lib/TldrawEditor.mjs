...
function TldrawEditorWithReadyStore({
  ...
  return (
    ...
    /* @__PURE__ */ (jsx(OptionalErrorBoundary, {
      ...
      children: crashingError ? /* @__PURE__ */ jsx(Crash, { crashingError }) : /* @__PURE__ */ jsx(EditorContext.Provider, { value: editor, children: /* @__PURE__ */ jsx(Layout, { autoFocus, onMount, children: children ?? (Canvas ? /* @__PURE__ */ jsx(Canvas, {}) : null) }) })
    }))
  );
}
function Layout({
