...
function SelectedIdIndicators() {
  const editor = (0, import_useEditor.useEditor)();
  const selectedShapeIds = (0, import_state.useValue)("selectedShapeIds", () => editor.getSelectedShapeIds(), [
    editor
  ]);
  ...
  if (!shouldDisplay)
    return null;
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: selectedShapeIds.map((id) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    ShapeIndicator,
    {
