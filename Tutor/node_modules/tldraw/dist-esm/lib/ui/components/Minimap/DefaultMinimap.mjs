...
function DefaultMinimap() {
  ...
  useQuickReactor(
    ...
    () => {
      ...
      minimap.contentPageBounds = commonBoundsOfAllShapesOnCurrentPage ? Box.Expand(commonBoundsOfAllShapesOnCurrentPage, viewportPageBounds) : viewportPageBounds;
      ...
      shapeIdsOnCurrentPage.forEach((id) => {
        ...
        if (pageMask) {
          ...
          pageBounds = Box.FromPoints(intersection);
        }
        if (pageBounds) {
          pageBounds.id = id;
