...
function EditSubmenu() {
  ...
  return /* @__PURE__ */ jsxs(TldrawUiMenuSubmenu, { id: "edit", label: "menu.edit", disabled: !selectToolActive, children: [
    ...
    /* @__PURE__ */ jsx(SetSelectionGroup, {})
  ] });
}
function ShapeSubmenu() {
  ...
  return /* @__PURE__ */ jsxs(TldrawUiMenuSubmenu, { id: "shape", label: "menu.shape", disabled: !selectToolActive, children: [
    /* @__PURE__ */ jsx(ConversionsMenuGroup, {}),
    /* @__PURE__ */ jsx(MultiShapeMenuGroup, {}),
    /* @__PURE__ */ jsx(MiscMenuGroup, {}),
    /* @__PURE__ */ jsx(EmbedsGroup, {}),
...
function MultiShapeMenuGroup() {
  return /* @__PURE__ */ jsxs(TldrawUiMenuGroup, { id: "multi-shape", children: [
