...
function InternalProviders({
  ...
  return /* @__PURE__ */ jsx(ActionsProvider, { overrides: mergedOverrides.actions, children: /* @__PURE__ */ jsx(ToolsProvider, { overrides: mergedOverrides.tools, children: /* @__PURE__ */ jsx(ToolbarSchemaProvider, { overrides: mergedOverrides.toolbar, children }) }) });
}
export {
