...
function getStrokePoints(rawInputPoints, options = {}) {
  ...
  pts.push(last);
  const isComplete = options.last || !options.simulatePressure || pts.length > 1 && Vec.Dist(pts[pts.length - 1], pts[pts.length - 2]) < size || pointsRemovedFromNearEnd > 0;
