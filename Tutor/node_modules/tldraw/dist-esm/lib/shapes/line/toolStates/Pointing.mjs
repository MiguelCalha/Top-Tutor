...
class Pointing extends StateNode {
  ...
  onEnter = (info) => {
    ...
    if (shape && inputs.shiftKey) {
      ...
      if (Vec.Dist(endHandle, prevEndHandle) < MINIMUM_DISTANCE_BETWEEN_SHIFT_CLICKED_HANDLES || Vec.Dist(nextPoint, endHandle) < MINIMUM_DISTANCE_BETWEEN_SHIFT_CLICKED_HANDLES) {
        points[endHandle.id] = {
          id: endHandle.id,
