...
class Pointing extends import_editor.StateNode {
  ...
  onEnter = (info) => {
    ...
    if (shape && inputs.shiftKey) {
      ...
      if (import_editor.Vec.Dist(endHandle, prevEndHandle) < MINIMUM_DISTANCE_BETWEEN_SHIFT_CLICKED_HANDLES || import_editor.Vec.Dist(nextPoint, endHandle) < MINIMUM_DISTANCE_BETWEEN_SHIFT_CLICKED_HANDLES) {
        points[endHandle.id] = {
          id: endHandle.id,
