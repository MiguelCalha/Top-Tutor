...
function ToggleAutoSizeMenuItem() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_TldrawUiMenuItem.TldrawUiMenuItem, { ...actions["toggle-auto-size"], disabled: !shouldDisplay });
}
function EditLinkMenuItem() {
  const actions = (0, import_actions.useActions)();
  const shouldDisplay = (0, import_menu_hooks.useHasLinkShapeSelected)();
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_TldrawUiMenuItem.TldrawUiMenuItem, { ...actions["edit-link"], disabled: !shouldDisplay });
}
function DuplicateMenuItem() {
  const actions = (0, import_actions.useActions)();
  const shouldDisplay = (0, import_menu_hooks.useUnlockedSelectedShapesCount)(1);
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_TldrawUiMenuItem.TldrawUiMenuItem, { ...actions["duplicate"], disabled: !shouldDisplay });
}
function GroupMenuItem() {
  const actions = (0, import_actions.useActions)();
  const shouldDisplay = (0, import_menu_hooks.useAllowGroup)();
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_TldrawUiMenuItem.TldrawUiMenuItem, { ...actions["group"], disabled: !shouldDisplay });
}
function UngroupMenuItem() {
  const actions = (0, import_actions.useActions)();
  const shouldDisplay = (0, import_menu_hooks.useAllowUngroup)();
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_TldrawUiMenuItem.TldrawUiMenuItem, { ...actions["ungroup"], disabled: !shouldDisplay });
}
function RemoveFrameMenuItem() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_TldrawUiMenuItem.TldrawUiMenuItem, { ...actions["remove-frame"], disabled: !shouldDisplay });
}
function FitFrameToContentMenuItem() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_TldrawUiMenuItem.TldrawUiMenuItem, { ...actions["fit-frame-to-content"], disabled: !shouldDisplay });
}
function ToggleLockMenuItem() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_TldrawUiMenuItem.TldrawUiMenuItem, { ...actions["toggle-lock"], disabled: !shouldDisplay });
}
...
function ConversionsMenuGroup() {
  const actions = (0, import_actions.useActions)();
  const shouldDisplay = (0, import_menu_hooks.useUnlockedSelectedShapesCount)(1);
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_TldrawUiMenuGroup.TldrawUiMenuGroup, { id: "conversions", children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
    import_TldrawUiMenuSubmenu.TldrawUiMenuSubmenu,
    {
      id: "export-as",
...
function SetSelectionGroup() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_TldrawUiMenuGroup.TldrawUiMenuGroup, { id: "set-selection-group", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_TldrawUiMenuItem.TldrawUiMenuItem, { ...actions["select-all"], disabled: !atLeastOneShapeOnPage }) });
}
...
function ArrangeMenuSubmenu() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_TldrawUiMenuSubmenu.TldrawUiMenuSubmenu, { id: "arrange", label: "context-menu.arrange", size: "small", children: [
    ...
    onlyFlippableShapeSelected && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_TldrawUiMenuGroup.TldrawUiMenuGroup, { id: "flip", children: [
...
function EmbedsGroup() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_TldrawUiMenuGroup.TldrawUiMenuGroup, { id: "embeds", children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_TldrawUiMenuItem.TldrawUiMenuItem, { ...actions["convert-to-bookmark"], disabled: !oneEmbedSelected }),
