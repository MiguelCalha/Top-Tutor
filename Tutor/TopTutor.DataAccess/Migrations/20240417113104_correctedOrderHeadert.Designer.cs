...
namespace TopTutor.DataAcess.Migrations
{
    ...
    [Migration("20240417113104_correctedOrderHeadert")]
    partial class correctedOrderHeadert
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TopTutor.Models.OrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TopTutor.Models.OrderHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime>("TutoringDay")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("TopTutor.Models.ShoppingCart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TopTutor.Models.OrderDetail", b =>
                {
                    b.HasOne("TopTutor.Models.OrderHeader", "OrderHeader")
                        .WithMany()
                        .HasForeignKey("OrderHeaderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TopTutor.Models.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("TopTutor.Models.OrderHeader", b =>
                {
                    b.HasOne("TopTutor.Models.ApplicationUser", "ApplicationUser")
                        .WithMany()
